...
\simpleplot{img/chapter_4/path_parts}{Demonstration of the structure of a coverage path. Orange: Path portion where the robot travels to its assigned region shown in blue. Red: Path segments that are straight line segments. Yellow: path segments that are transition segments.}{fig:path_parts}
...
\simpleplot{img/chapter_4/sample_area}{Sample workspace with parallel line segments.}{fig:sample_area}%

\begin{figure}
	\centering
	\begin{subfigure}{0.5\linewidth}
		\centering
		\subfile{img/chapter_4/area_error}%
		\caption{\label{fig:area_error_i}}
	\end{subfigure}%
	\begin{subfigure}{0.5\linewidth}
		\centering
		\subfile{img/chapter_4/area_error_i}
		\caption{\label{fig:area_error_i}}
	\end{subfigure}
...
\begin{equation}
	\beta\leq 0.5\alpha.
\end{equation}
\simpleplot{img/chapter_4/skeleton_altitude}{Minimum altitude of a convex polygon, $\alpha$. Distance to the center contour, $\beta$.}{fig:skeleton_altitude}
