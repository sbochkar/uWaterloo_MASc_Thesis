...
\simpleplot{img/chapter_4/segmented_path}{An example of a segmented path.}{fig:segmented}
...
\simpleplot{img/chapter_4/riemann_sum}{Parallel line arrangement.}{fig:riemann_sum}
...
\simpleplot{img/chapter_4/altitude}{Process of measuring altitude with $\theta$ equal to 0.}{fig:altitude}
