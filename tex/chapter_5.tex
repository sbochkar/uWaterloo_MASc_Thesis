...
Algorithm~\ref{alg:reopt_cut} computes an improving cut if it exists. 

An efficient $\mathbb{O}(n)$ algorithm for computing a visibility polygon is proposed in~\cite{el1981linear}
...
\begin{table}
	\centering
	\caption{Improvement on decomposition.}
	\label{table:decomposition_improvement}
	\begin{tabular}{@{}l rrrrr}
		\toprule
		& \multicolumn{2}{c}{Max $\chi$} && \multicolumn{2}{c}{Max Tour Length} \\
		\cmidrule{2-6}
		& Old & New & & Old & New \\
		%&& Size & Time & Length & Area \\
		\cmidrule{1-6}
		Shape 1 & 47.5 & \bf{41.6}   && 30.7 & \bf{26.0} \\
		Shape 2 & 228.1 & \bf{169.3} && 187.0 & \bf{126.7}\\
		Shape 3 & 207.5 & \bf{180.0} && 169.5 & \bf{152.3}\\
		%\midrule
