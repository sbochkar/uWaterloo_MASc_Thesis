...
\begin{equation}
	\mathbb{O}\left((n+\frac{\alpha_{\min,n}}{r})n\log{n}+(m+\frac{\alpha_{\min,m}}{r})m\log{m}\right).
\end{equation}
Hence, the whole step can be performed with the following run time:
\begin{equation}
	\mathbb{O}\left(K(m+n)\left[(n+\frac{\alpha_{\min,n}}{r})n\log{n}+(m+\frac{\alpha_{\min,m}}{r})m\log{m}\right]\right).
\end{equation}
